    ...
    <div style="height: 60px; background-color: #2e3143; display: flex; align-items: center;">
      <div style="flex: 1">
        <div style="padding-left: 20px; display: flex; align-items: center">
          ...
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px; color: #fff">校园小卖部平台</div>
        </div>
      </div>
      <div style="width:60%;height: 60px;display: flex;align-items: center">
        <div style="flex:1">
          <el-menu router :default-active="router.currentRoute.value.path" style="background-color: #2e3143" ellipsis mode="horizontal">
            ...
            <el-menu-item index="/front/userComment">我的评价</el-menu-item>
          </el-menu>
        </div>
      ...
      <div style="width: 20%; padding-right: 10px; text-align: right">
        <el-dropdown>
          <div style="display: flex; align-items: center;">
            ...
            <span style="color: #fff; margin-left: 5px">{{ data.user.name || 'xx' }}</span>
          </div>
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item @click.native="router.push('/front/userCollect')">收藏列表</el-dropdown-item>
              <el-dropdown-item @click.native="router.push('/front/userRecharge')">我的钱包</el-dropdown-item>
